...
class MUTopBar : RelativeLayout, MUViewHelper {
     ...
     */
    private var mButtonImage = R.drawable.ic_launcher_background
    /**
     * The left padding
     */
     ...
     * @property muTopBarClickListener the [MUTopBarClickListener] to attach.
     */
    var muTopBarClickListener: MUTopBarClickListener? = null
        set(clickListener) {
            field = clickListener
            clickListener?.let {
                val listener = it
                mIBLeftButton?.setOnClickListener { listener.clickOnMUTopBar() }
                setOnClickListener { listener.clickOnMUTopBar() }
            } ?: run {
     ...
     */
    interface MUTopBarClickListener {
        fun clickOnMUTopBar()
    }
    ...
    companion object {
         ...
         */
        private const val DEFAULT_TITLE_SIZE_IN_SP = 24f
        /**
         * The default width of button
         */
        private const val DEFAULT_BUTTON_WIDTH_IN_SP = 40f
    }
}
