...
class MUPageControl : LinearLayout, MUViewHelper {
     ...
     * @property pageControlListener the listener which handles click on elements
     */
    var pageControlListener: MUPageControlListener? = null
    ...
    private inner class Indicator(context: Context, private val mPosition: Int, muPageControl: MUPageControl) : LinearLayout(context) {
        ...
        private val mClickListener = OnClickListener {
            ...
            if (null != pageControlListener) {
                pageControlListener?.clickOnIndex(muPageControl, mPosition)
            }
        }
    ...
    interface MUPageControlListener {
        fun clickOnIndex(muPageControl: MUPageControl, index: Int)
    }
}
